 ...
 *      as well as the machine-specific ones transistor size, transistor type
 *      and gate type.
 */
public class TransistorControlRoomView extends ControlRoomView {
	...
	public void update(Machine currMachine) {
		 ...
		 * update this method:
		 * 2. TODO: Use the values from the machine (current-temperature,
		 * current-voltage, transSize, transType\
	 ...
	 * setGateType button
	 * in order to update the machine with the input values from the respective text
	 * fields.
	 */
